...
import { useForm } from 'react-hook-form' // 表单验证
...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center p-4" style={{ 
      backgroundImage: `url('/l@3000x2250@1x-v2.webp')`,
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-soft p-8 space-y-6">
          ...
          <div className="text-center space-y-2">
            ...
            <p className="text-gray-500 text-sm">Log in to continue to WorldWander - 世界漫游图</p>
          </div>
        ...
        <p className="text-center text-xs text-gray-400 mt-6">
          © 2026 WorldWander - 世界漫游图. All rights reserved.
        </p>
