...
.border-aden-white\/10{
  border-color: rgb(255 255 255 / 0.1);
}
.border-aden-white\/30{
...
.from-aden-dark-blue{
  --tw-gradient-from: #0A2463 var(--tw-gradient-from-position);
  --tw-gradient-to: rgb(10 36 99 / 0) var(--tw-gradient-to-position);
...
.text-aden-dark-blue{
  --tw-text-opacity: 1;
  color: rgb(10 36 99 / var(--tw-text-opacity, 1));
}
.text-aden-dark-grey{
  --tw-text-opacity: 1;
...
.text-brand-600{
  --tw-text-opacity: 1;
  color: rgb(85 104 211 / var(--tw-text-opacity, 1));
}
.text-gray-400{
  --tw-text-opacity: 1;
...
/* 全局样式 */
body {
  font-family: 'Catamaran', 'OPPOSans', sans-serif;
  color: #333333;
  background-color: #FFFFFF;
}

h1, h2, h3, h4, h5, h6 {
  font-family: 'Figtree', 'OPPOSans', sans-serif;
}
...
.hover\:border-aden-white:hover{
  --tw-border-opacity: 1;
  border-color: rgb(255 255 255 / var(--tw-border-opacity, 1));
}
.hover\:bg-aden-dark-blue\/90:hover{
  background-color: rgb(10 36 99 / 0.9);
}
.hover\:bg-aden-orange\/10:hover{
  background-color: rgb(255 107 0 / 0.1);
}
.hover\:bg-aden-orange\/90:hover{
  background-color: rgb(255 107 0 / 0.9);
}
...
.hover\:from-brand-600:hover{
  --tw-gradient-from: #5568d3 var(--tw-gradient-from-position);
  --tw-gradient-to: rgb(85 104 211 / 0) var(--tw-gradient-to-position);
  --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);
}
.hover\:to-purple-700:hover{
  --tw-gradient-to: #7e22ce var(--tw-gradient-to-position);
}
.hover\:text-aden-orange:hover{
  --tw-text-opacity: 1;
  color: rgb(255 107 0 / var(--tw-text-opacity, 1));
}
